...
function annoletContainer(){
    ...
    linktag.href = "https://rawgit.com/ren-admin/pgxfrm-annolet/ea8b94cae21c9c226d0fc9ed2af88ae8e500cf41/src/pgxfrm-bookmarklet/annolet/css/pgxfrm-annolet.css"; 
...
#+END_SRC
* Function =createMenulist()= creates menulist of the tags by fetching the content from json.
#+BEGIN_SRC js :tangle ../../code/annolet/pgxfrm-annolet.js :eval no

function createMenulist(result){
	console.log("inside createTags....");
	console.log(result);
...
function addclickEvents() {
    document.getElementById('category-0').addEventListener('click', function() {
        alert("hello");
        // var category = json_data.main_menu[i].name;
        // alert(category);
