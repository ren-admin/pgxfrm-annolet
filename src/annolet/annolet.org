...
* Function =disableLinks()= to disable all links on a webpage.
...
* Function =disableCss()= disable the css of a web page.
...
* Function =ZapPer()= to erase the unwanted content on a webpage.
...
* Function =modifyContent()= to modify the content on a web page.
...
* Function =highlightContent()= to highlight selected text on a web page.
...
* Function =highlightRange(range)= for highlighting the selected text.
...
* Function =phoneticsTrans()= to translate the selected text to phonetics.
...
* Function =translateText()= to translate the selected text to an other language.
...
* Function =alternateStylesheets()= to create alternate stylesheets, which will be used to change the theme of a web page.
...
* Function =switchStyle(css_title)= to switch the theme of a web page.
...
* Function =showContent()= to display the selected content on the web page and rest of the content is made hidden.
...
* Function =changeFont()= to increase/decrease the font size of the content.
...
* Function =convertCurrency()= to convert the currency
...
* Function =changeMeasurement()= to convert units of measurements
...
* Function =convertNumsys()= to convert the number in preferred number system.
...
* Function =formatDate()= to format the date as per the preferred country.
